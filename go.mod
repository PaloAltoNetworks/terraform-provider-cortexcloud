...
require (
	github.com/PaloAltoNetworks/cortex-cloud-go/cloudonboarding v1.0.2
	github.com/PaloAltoNetworks/cortex-cloud-go/enums v1.0.2
	github.com/PaloAltoNetworks/cortex-cloud-go/log v1.0.2
	github.com/PaloAltoNetworks/cortex-cloud-go/platform v1.0.2
