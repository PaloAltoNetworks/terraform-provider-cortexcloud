		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cortexcloud_user.u", "user_first_name", "John"),
					resource.TestCheckResourceAttr("cortexcloud_user.u", "user_last_name", "Doe"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("cortexcloud_user.u", "user_email", "test@example.com"),
					resource.TestCheckResourceAttr("cortexcloud_user.u", "user_first_name", "Jane"),
					resource.TestCheckResourceAttr("cortexcloud_user.u", "user_last_name", "Doe"),
				),
			},
		},
