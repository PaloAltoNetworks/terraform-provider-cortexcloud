		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cortexcloud_cloudsec_policy.test", "rule_matching.rules.#", "3"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "rule_matching.rules.*", "rule-id-1"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "rule_matching.rules.*", "rule-id-2"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "rule_matching.rules.*", "rule-id-3"),
					resource.TestCheckResourceAttr("cortexcloud_cloudsec_policy.test", "asset_matching.type", "ASSET_GROUPS"),
					resource.TestCheckResourceAttr("cortexcloud_cloudsec_policy.test", "asset_matching.asset_group_ids.#", "2"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "asset_matching.asset_group_ids.*", "100"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "asset_matching.asset_group_ids.*", "200"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cortexcloud_cloudsec_policy.test", "asset_matching.cloud_account_ids.#", "2"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "asset_matching.cloud_account_ids.*", "account-1"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "asset_matching.cloud_account_ids.*", "account-2"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("cortexcloud_cloudsec_policy.test", "rule_matching.type", "RULES"),
					resource.TestCheckResourceAttr("cortexcloud_cloudsec_policy.test", "rule_matching.rules.#", "2"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "rule_matching.rules.*", "rule-1"),
					resource.TestCheckTypeSetElemAttr("cortexcloud_cloudsec_policy.test", "rule_matching.rules.*", "rule-2"),
				),
			},
		},
	})
